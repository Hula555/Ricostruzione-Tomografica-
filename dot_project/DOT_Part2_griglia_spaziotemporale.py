...
print("sorgente-rivelatori, finestre temporali). La prossima parte costruira' la")
print("matrice di sensitivita' W, il vettore dei voxel A e il vettore delle misure")
print("M = W . A per il problema diretto, senza rumore.")
